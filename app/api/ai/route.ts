...
Along with response also send which ui component to display for generative UI - 'budget (or) groupSize (or) tripDuration (or) final', where final means AI generating complete plan.
...
const FINAL_PROMPT = `Generate Travel Plan with give details, give me Hotels list with HotelName, Hotel address, Price, hotel image url, geo coordinates, rating, descriptions and suggest itinerary with placeName, Place Details, Geo Coordinates, Place address, ticket Pricing, Time travel each of the location , with each day plan with best time to visit in a JSON Output Schema:
{
  "trip_plan": {
    "destination": "string",
    "duration": "string",
